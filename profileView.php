...
include_once('businessLayer/sessionStart.php');
	...
	if(empty($_GET['id'])){
		...
		$achvs=$db->getUserAchievements($_GET['id']);
                            ...
                            <div class="row profile-row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <?php 
            							...
            							$sesUser= $userInfo[0]["User_ID"];
            							if ($pUser != $sesUser){
                					echo "<div class='col-md-4 col-sm-12 center'><img class='img-circle' style='width:150px;height:150px;padding:0;margin-left:5px;' src='".$user[0]["Avatar"]."'></div>";
									}?>
                                        <div class="col-md-6 col-sm-12" style="padding-top: 10px; padding-bottom: 20px;">
								...
								<div class="form-group">
                                    ...
                                    <div class="row">
                                    	...
                                    	<?php 
            								...
            								echo "<h3 style='color:rgba(31,148,255,1);'>".$user[0]["User_Name"]."'s Owen Projcts: </h3>";
                                    	...
                                    	echo "<h3 style='color:rgba(31,148,255,1);'>".$user[0]["User_Name"]."'s Achievements: </h3>
                                    	<p>List of completed projects for other clients through ePartner</p>";
            								echo "<table class='table table-striped table-bordered table-hover'>
            								<thead>
                                            <tr>
                                                <th style='display:none;'>ID</th>
                                        ...
                                        <tbody>";
                                         foreach ($achvs as $achv){
                                         	$prjOnwer=$db->getUserInfoByID($achv["User_ID"]);
    										echo "<tr>  
    													<td style="."display:none;".">".$achv['Prj_ID']."</td>
    													<td><a href='ProjectView.php?id=".$achv['Prj_ID']."' alt='edit'>".$achv['Prj_Name']."</a></td>
    													<td>".$achv['Prj_Category']."</td>
    													<td><a href='profileView.php?id=".$achv["User_ID"]."'>".$prjOnwer[0]["User_Name"]."</a></td>
    		  											<td>".$achv['Prj_Budget']."</td>
    		  											<td>".$achv['Prj_Period']."</td>
    		  										</tr>";}
                                        echo "</tbody>
                                    </table>"; 
            								}
