...
$pro=$db->getProByID($_GET['id']);
$prj=$db->getPrjByID($pro[0]["Project_ID"]);
...
$proEnquiry=$_POST['proEnquiry'];
	...
	$updatedPro = $db->updatePro($proID, $proAmount, $proPeriod, $proEnquiry);
	
	if($updatedPro>=1){
         header('location: ProposalView.php?id='.$pro[0]["ProID"]); 
		}
	else{
...
<body style="margin-top:59px;">
   ...
   {include("businessLayer/navBarNoS.html");}?>
    <div class="container" id="info-container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center text-info" style="color:rgb(10,111,183);">Edit Proposal</h2></div>
		        <div class="row profile-row">
                    <?php include("businessLayer/userNav.html"); ?>
            <div class="col-md-6 col-sm-6 col-xs-12 site-form">
                <form id="my-form" method="post">
                    <div class="form-group">
                    	<span> <h5>For project Name: "<?php echo $prj[0]["Prj_Name"]; ?>"</h5> </span>
                        <input class="form-control" type="text" name="proAmount" value="<?php echo $pro[0]["ProAmount"];?>" placeholder="Your proposal in SAR" required="" id="firstname" style="margin-top:19px;">
                        <input class="form-control" type="text" name="proPeriod" value="<?php echo $pro[0]["ProPeriod"];?>" placeholder="Project Duration" required="" id="firstname" style="margin-top:19px;">
                    </div>
                    
                    <div class="form-group">
                        <textarea class="form-control" rows="8" name="proEnquiry" required="" placeholder="Enquiry About The Project"><?php echo $pro[0]["ProEnquiry"];?></textarea>
                    </div>
