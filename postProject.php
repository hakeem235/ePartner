...
$prjcategory=$_POST['Category']; 
	...
	$newPrj = $db->insertPrj($userID, $prjname, $prjdes, $prjbudget, $prjperiod, $prjcategory);
	
	if($newPrj>=1){
         header('location: MyProjectList.php'); 
	}
...
<body style="margin-top:59px;">
   ...
   {include("businessLayer/navBarNoS.html");}?>
    <div class="container" id="info-container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center text-info" style="color:rgb(10,111,183);">Post New Project </h2></div>
           <div class="row profile-row">
                <?php include("businessLayer/userNav.html"); ?>
            <div class="col-md-6 col-sm-6 col-xs-12 site-form">
                <form id="my-form" method="post">
                    <div class="form-group">
                        <input class="form-control" type="text" name="ProjectName" placeholder="Project Name" id="ProjectName">
                    </div>
                    <div class="dropdown">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" rows="8" name="Description" required="" placeholder="Project Description" style="margin-top:14px;"></textarea>
                        <input class="form-control" type="text" name="ProjectBudget" placeholder="Budget in SAR" id="ProjectBudget" style="margin-top:14px;">
                        <input class="form-control" type="text" name="ProjectPeriod" placeholder="Project Period in days" id="ProjectPeriod" style="margin-top:14px;">
                    </div>
                    <button class="btn btn-primary form-btn" type="submit" name="submit" id="submit" style="margin-top:16px;">Puplish </button>
                </form>
            </div>
